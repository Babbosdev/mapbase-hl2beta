...
ConVar    sk_plr_dmg_small_round("sk_plr_dmg_small_round", "0", FCVAR_REPLICATED);
	...
	ConVar    sk_leak_dmg_sniper_penetrate_plr("sk_leak_dmg_sniper_penetrate_plr", "0", FCVAR_REPLICATED);
	ConVar    sk_leak_dmg_sniper_penetrate_npc("sk_leak_dmg_sniper_penetrate_npc", "0", FCVAR_REPLICATED);

...
STUB_WEAPON_CLASS( weapon_pistol, WeaponPistolRetail, C_BaseHLCombatWeapon );
...
// Leak (MOVE TO DIFFRENT CODE FILE LATER!)

STUB_WEAPON_CLASS(weapon_pistol_old, WeaponPistolLeak, C_BaseHLCombatWeapon);
